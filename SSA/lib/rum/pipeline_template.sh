...
perl SCRIPTSDIR/merge_GU_and_TU.pl OUTDIR/GNU.CHUNK OUTDIR/TNU.CHUNK OUTDIR/GU.CHUNK OUTDIR/TU.CHUNK OUTDIR/BowtieUnique.CHUNK OUTDIR/CNU.CHUNK PAIREDEND
